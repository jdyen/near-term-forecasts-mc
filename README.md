### Near-term forecasting to inform environmental flows

#### Overview

This repository contains code to forecast Murray Cod population outcomes under
...
Data snapshots are provided in the `data/` directory to reproduce the analysis.
